...
const Footer = () => {
    ...
    return (
        <div className="mb-0">
            <footer className="footer p-10 bg-sky-950 text-white">
                <div>
            ...
            <footer className="footer px-10 py-4 border-t text-white bg-sky-950 border-base-300">
            ...
            <footer className="footer footer-center p-4 bg-sky-950 text-white">
                <div>
